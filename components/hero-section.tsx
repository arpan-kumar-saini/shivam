          ...
          >
            <div className="flex-1 pr-8 text-center md:text-left ">
              ...
              <motion.p
                ...
                className="text-xl md:text-2xl text-indigo-900 mb-8 md:hidden font-semibold"
              >
              ...
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
                className="text-xl md:text-2xl text-indigo-900 mb-8 hidden md:block font-semibold"
              >
                Rajkiya Engineering College ,Bijnor
              </motion.p>
              <motion.div
